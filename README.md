...
![Tests](https://img.shields.io/badge/unit_tests-4%2F4_passing-16803C)
...
> **Engineering status:** the software framework is operational. The Rev-A PCB is a design in progress, not a fabrication release. KiCad reports zero geometric DRC violations, but 36 low-current connections still require interactive routing and schematic parity review.
...
| Output ripple | 2,000 samples at 10 kS/s | Robust Vpp | <50 mVpp |
...
The MCP3008 path is intended for automated screening and low-frequency ripple analysis. Final switching-ripple sign-off should use a bandwidth-limited oscilloscope measurement with a short ground spring.
...
PASS   Output ripple: Ripple 30.1 mVpp; mean 4.993 V
...
View the self-contained [HTML report](artifacts/report.html), [machine-readable results](artifacts/results.json), and individual CSV files in `artifacts/`.
...
hardware/
  ...
  protected_buck.sch            connected legacy schematic for KiCad import
...
validation/
  ...
  real_bench.py                 PyVISA, MCP3008, and GPIO adapters
...
2. Calibrate every ADC divider and record its gain and offset.
